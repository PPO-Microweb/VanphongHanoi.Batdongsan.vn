...
Hướng: $direction<br />
Hướng ban công: $direction_balcony<br />
Số tầng: $so_tang <br />
            ...
            <div class="thongtincoban">
                ...
                <div class="thongtin-content postnews-content">
                    <div class="item row">
                        ...
                        <div class="col-sm-4">
<!--                            <input type="radio" id="loai_bds_ban" value="Bán" name="loai_tin" class="radio" />
                            <label for="loai_bds_ban" class="radio_type">BÁN</label>-->
                            <input type="radio" id="loai_bds_cho_thue" value="Cho thuê" name="loai_tin" class="radio" checked />
            ...
            <div class="thongtinkhac">
                ...
                <div class="thongtinkhac-content postnews-content">
                    <div class="item row">
                        ...
                        <div class="col-sm-4 mb15 hide hidden">
                            <div class="row">
                                <div class="col-sm-5 pdr0">
