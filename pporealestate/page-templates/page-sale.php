    ...
    <div class="formsale postnews">
        <form name="formSales" id="formSales" method="post" action="">
            ...
            <div class="thongtincoban">
                <h1 class="title_postnews">Gửi yêu cầu thuê bất động sản</h1>
            </div>
            <?php if(!empty($notify)): ?>
            ...
            <div class="thongtincoban">
                ...
                <div class="thongtin-content postnews-content">
                    <div class="item row">
                        ...
                        <div class="col-sm-4">
<!--                            <input type="radio" id="loai_bds_mua" value="Mua" name="loai_tin" class="radio" />
                            <label for="loai_bds_mua" class="radio_type">MUA</label>-->
                            <input type="radio" id="loai_bds_thue" value="Thuê" name="loai_tin" class="radio" checked />
